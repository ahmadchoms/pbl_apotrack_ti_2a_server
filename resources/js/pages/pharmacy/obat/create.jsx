                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-6">
                        <div className="space-y-5">
                            ...
                            >
                                        ...
                                        {images.map((img, idx) => (
                                            <motion.div
                                                ...
                                                className={`relative w-16 h-16 rounded-xl overflow-hidden border-2 cursor-pointer transition-all ${
                                                    idx === primaryIndex
                                                        ? "border-[#00346C] ring-2 ring-[#00346C]/20"
                                ...
                                {images.length === 0 && (
                                    <div className="mt-3 flex items-center gap-2 bg-slate-50 rounded-xl border border-slate-100 p-3">
                        ...
                        <div className="space-y-5">
                            ...
                            >
                                ...
                                <p className="text-[10px] text-amber-600 font-semibold leading-relaxed">
                                    Pastikan semua informasi obat sudah
                                    diperiksa dengan teliti sebelum menyimpan.
                                    Data stok dan batch akan tercatat langsung
                                    di inventaris apotek.
                                </p>
                            </motion.div>
