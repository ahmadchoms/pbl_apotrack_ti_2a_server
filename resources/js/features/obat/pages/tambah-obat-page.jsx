// resources/js/features/obat/pages/tambah-obat-page.jsx
...
export default function TambahObatPage({ onBack, onSimpan }) {
    const [form, setForm] = useState({
        nama: "", kategori: "", bentuk: "", harga: 0, stok: 0,
    });
        ...
        <div className="p-8">
            <div className="mb-7">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <h1 className="text-2xl font-bold text-[#1a2744]">Tambah Obat Baru</h1>
                </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
                ...
                <Card className="w-72 shrink-0">
                    ...
                    <CardContent className="space-y-3">
                        <label htmlFor="upload-tambah" className="flex flex-col items-center justify-center border-2 border-dashed border-border rounded-lg h-48 cursor-pointer bg-muted/40 hover:bg-muted/60 transition overflow-hidden">
                            {imagePreview
                        ...
                        <input id="upload-tambah" type="file" accept="image/*" onChange={handleImage} className="hidden" />
                        {imagePreview && (
                ...
                <Card className="flex-1">
                    <CardContent className="pt-6 space-y-5">
                        ...
                        <div className="space-y-1">
                            ...
                            <Input id="bentuk" name="bentuk" value={form.bentuk} onChange={handleChange} placeholder="Strip, Tablet, Botol" />
                        </div>
