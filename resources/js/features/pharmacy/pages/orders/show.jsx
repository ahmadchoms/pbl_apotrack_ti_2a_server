...
export default function OrderShow({ order: orderWrapper }) {
    ...
    const handleValidatePrescription = (status) => {
        router.patch(
            route(
                "pharmacy.orders.prescription.validate",
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 px-4">
                            ...
                            <div className="p-8 border-b border-slate-50 flex items-center justify-between">
                                ...
                                {order.prescription?.image_url && (
                                    <Button
                                        variant="ghost"
                                        size="sm"
                                        className="h-8 rounded-lg text-[10px] font-bold uppercase tracking-wider text-violet-600 hover:bg-violet-50"
                                        onClick={() =>
                                            window.open(
                                                order.prescription.image_url,
                                                "_blank",
                                ...
                                {needsPrescription ? (
                                        ...
                                        {order.prescription?.image_url ? (
                                            <>
                                                ...
                                                <div className="absolute bottom-6 right-6 opacity-0 group-hover:opacity-100 transition-all transform translate-y-2 group-hover:translate-y-0">
                                                    <Button
                                                        variant="secondary"
                                                        className="h-10 rounded-xl font-bold text-xs gap-2 shadow-xl bg-white/90 backdrop-blur"
                                                        onClick={() =>
                                                            setIsZoomed(true)
                                                        }
                                                    >
                                    ...
                                    <div className="flex-1 flex flex-col items-center justify-center text-center p-12 bg-white rounded-[3rem] border border-slate-100 shadow-inner">
                                        ...
                                        <p className="text-xs text-slate-500 mt-3 font-medium italic leading-relaxed">
                                            "Pesanan ini tidak mengandung obat
                                            golongan keras yang memerlukan resep
                                            dokter."
                                        </p>
                                    </div>
                                )}
                    ...
                    <div className="lg:col-span-7 xl:col-span-8 space-y-8">
                            ...
                            <Card className="rounded-[2.5rem] border-slate-200/80 shadow-xl shadow-slate-200/20 bg-white p-8">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <Badge
                                            className={`rounded-full px-3 py-1 text-[9px] font-black uppercase tracking-widest border ${statusCfg.badge}`}
                                        >
                                            {statusCfg.label}
                                        </Badge>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span
                                            className={`text-xs font-black uppercase tracking-wider ${order.payment_status === "PAID" ? "text-emerald-600" : "text-amber-500"}`}
                                        >
                        ...
                        <Card className="rounded-[2.5rem] border-slate-200/80 shadow-2xl shadow-slate-200/20 bg-white overflow-hidden">
                                ...
                                <table className="w-full">
                                    <thead className="bg-slate-50/50 border-b border-slate-100">
                                        <tr>
                                            ...
                                            <th className="px-4 py-4 text-center text-[10px] font-black text-slate-400 uppercase tracking-widest">
                                                Jumlah
                                            </th>
                                                    ...
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div className="min-w-0">
                                                            ...
                                                            {item.requires_prescription && (
                                                                <Badge className="mt-1 h-4 px-1.5 bg-rose-50 text-rose-500 border-rose-100 text-[8px] font-black uppercase tracking-widest">
                                                                    Wajib Resep
                                                                </Badge>
                                                            )}
                                                        </div>
                            ...
                            <div className="p-10 bg-primary/5 flex items-center justify-between border-t border-primary/10">
                                <div className="flex flex-col">
                                    <span className="text-[10px] font-black text-primary/60 uppercase tracking-[0.2em]">
                                        Total Pembayaran
                                    </span>
                                    <span className="text-xs text-primary/40 font-bold uppercase mt-1 italic">
                                        Termasuk biaya layanan & PPN
                                    </span>
                                </div>
                ...
                <DialogContent className="max-w-md rounded-[2.5rem] p-8 border-slate-100 shadow-2xl">
                    <DialogHeader>
                        ...
                        <p className="text-sm text-slate-500 font-medium mt-2 leading-relaxed">
                            ...
                            pelanggan dapat memahami mengapa pesanan tidak dapat
                            diproses.
                        </p>
                    </DialogHeader>
                    <div className="py-6">
                        <textarea
                            className="w-full h-32 rounded-2xl border-slate-100 bg-slate-50 text-sm p-4 focus:ring-primary focus:border-primary placeholder:text-slate-300 font-medium"
