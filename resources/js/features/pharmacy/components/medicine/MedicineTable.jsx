                                ...
                                >
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p className="text-sm font-black text-slate-800 leading-tight mb-0.5">
                                                    {medicine.name}
                                                </p>
                                    ...
                                    <td className="px-6 py-4">
                                        <span className="inline-flex items-center px-2.5 py-1 rounded-full bg-blue-50 text-primary text-[9px] font-black uppercase tracking-widest border border-blue-100">
                                            {medicine.category}
                                        </span>
                                    </td>
                                    <td className="px-6 py-4">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex flex-col">
                                            <p
                                                className={`text-sm font-black tabular-nums ${stockStatus === "empty" ? "text-red-500" : stockStatus === "low" ? "text-amber-500" : "text-primary"}`}
                                            >
                                    ...
                                    <td className="px-6 py-4 text-center">
                                        <DropdownMenu>
                                            ...
                                            >
                                                <DropdownMenuItem
                                                    className="rounded-xl py-2.5 text-[10px] font-black uppercase tracking-widest text-slate-600 focus:bg-blue-50 focus:text-primary cursor-pointer"
                                                    onClick={() =>
                                                        onView(medicine)
                                                    }
                                                >
                                                ...
                                                <AlertDialog>
                                                    ...
                                                    <AlertDialogContent className="rounded-3xl p-8 border-slate-100 shadow-2xl">
                                                        ...
                                                        <AlertDialogFooter className="mt-8 gap-3">
                                                            <AlertDialogCancel className="h-12 rounded-2xl font-black text-[10px] uppercase tracking-widest border-slate-200">
                                                                Batal
                                                            </AlertDialogCancel>
                                                            <AlertDialogAction
