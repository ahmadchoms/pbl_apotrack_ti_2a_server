...
export function LoginForm({ onSubmitSuccess }) {
    ...
    const handleGoogleLogin = () => {
        console.log("Mengarahkan ke otentikasi Google...");
    };
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-4 pt-2">
                ...
                <Button
                    ...
                    className="w-full bg-white hover:bg-slate-50 text-slate-700 border-slate-200 hover:border-slate-300 py-6 rounded-xl font-semibold transition-all"
                >
