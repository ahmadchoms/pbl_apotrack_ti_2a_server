        ...
        <TableRow className="group hover:bg-slate-50/50 transition-colors border-slate-100/50">
            ...
            <TableCell>
                <div className="flex flex-col items-start gap-1">
                    ...
                    {user.pharmacy_name && (
                        <span className="text-[9px] font-bold text-primary bg-primary/5 px-2 py-0.5 rounded-md">
                            {user.pharmacy_name}
                        </span>
                    )}
                </div>
            ...
            <TableCell>
                <div
                    className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full border text-[9px] font-black tracking-widest ${statusCfg.badge}`}
                >
                    <span
