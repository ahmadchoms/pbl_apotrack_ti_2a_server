    ...
    return (
        <Card className="py-0 gap-0 rounded-[2.5rem] border-2 border-dashed border-rose-100 bg-rose-50/20 overflow-hidden">
            <CardHeader className="p-8">
                ...
                <CardDescription className="text-xs font-extrabold text-slate-400 mt-1">
                    Tindakan yang dapat berdampak signifikan pada operasional
                    mitra
                </CardDescription>
            </CardHeader>
                ...
                >
                    <DialogTrigger asChild>
                        <Button
                            ...
                            className={`h-11 px-5 rounded-xl text-xs font-extrabold tracking-wide transition-all border-0 shadow-sm text-white ${
                                isSuspended
                    ...
                    <DialogContent className="sm:max-w-106.25 rounded-[2rem]">
                        <DialogHeader className="flex flex-col items-center text-center">
                            <div
                                className={`w-16 h-16 rounded-full flex items-center justify-center mb-4 ${isSuspended ? "bg-emerald-50" : "bg-rose-50"}`}
                            >
                                <AlertTriangle
                                    className={`w-10 h-10 ${isSuspended ? "text-emerald-500" : "text-rose-500"}`}
                                />
                            </div>
                            ...
                            <DialogDescription className="text-sm font-extrabold text-slate-500 mt-2 px-4">
                                {isSuspended
                        ...
                        <div className="bg-slate-50 p-6 rounded-3xl my-4 border border-slate-100">
                            <div className="flex items-start gap-4">
                                ...
                                <p className="text-[11px] font-extrabold text-slate-600 leading-relaxed italic">
                                    "Tindakan suspensi biasanya dilakukan karena
                                    adanya pelanggaran syarat & ketentuan atau
                                    ketidakvalidan dokumen yang fatal."
                                </p>
                            </div>
                        </div>
                        <DialogFooter>
                            <div className="space-y-3 w-full">
                                <Button
                                    className={`w-full h-11 rounded-xl text-xs font-extrabold tracking-wide transition-all border-0 shadow-sm text-white ${
                                        isSuspended
                                            ? "bg-emerald-600 hover:bg-emerald-700"
                                            : "bg-rose-600 hover:bg-rose-700"
                                    }`}
                                ...
                                <Button
                                    variant="ghost"
                                    className="w-full h-11 rounded-xl text-xs font-extrabold tracking-wide text-slate-500 hover:text-slate-900 hover:bg-slate-50 transition-all"
                                    onClick={() =>
