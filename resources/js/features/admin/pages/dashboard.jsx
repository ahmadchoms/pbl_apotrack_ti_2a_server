...
export default function AdminDashboard({ stats = {}, charts = {}, auditLogs = [] }) {
    return (
        <DashboardAdminLayout activeMenu="dashboard">
            <div className="space-y-10">
                <PageHeader subtitle="Sistem Administrasi" title="Dashboard Utama" description="Pantau performa ekosistem dan manajemen node secara real-time.">
                    <button className="h-11 px-6 rounded-2xl bg-white border border-slate-200 text-slate-600 font-bold text-xs hover:bg-slate-50 transition-all flex items-center gap-2 shadow-sm">
